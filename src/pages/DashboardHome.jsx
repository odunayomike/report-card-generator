  ...
  return (
    <div>
      ...
      {!loadingSettlement && !settlementInfo?.has_subaccount && (
        <div className="mb-6 bg-primary-600 rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-white/90">
                  Set up your settlement account to start collecting fees through our platform.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-5 py-2 bg-white text-primary-600 rounded-lg hover:bg-gray-50 transition-colors font-medium whitespace-nowrap"
              >
                Set Up Now
              </button>
            </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4 mb-8">
        <Link to="/dashboard/students" className="bg-white rounded-lg shadow p-3 sm:p-4 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="flex-1">
              <p className="text-xs font-medium text-gray-600">Total Students</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{analytics?.totalStudents || 0}</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-lg flex items-center justify-center self-start sm:self-auto">
        ...
        <Link to="/dashboard/manage-teachers" className="bg-white rounded-lg shadow p-3 sm:p-4 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="flex-1">
              <p className="text-xs font-medium text-gray-600">Total Teachers</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{analytics?.totalTeachers || 0}</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 rounded-lg flex items-center justify-center self-start sm:self-auto">
        ...
        <Link to="/dashboard/students" className="bg-white rounded-lg shadow p-3 sm:p-4 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="flex-1">
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{analytics?.totalClasses || 0}</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-lg flex items-center justify-center self-start sm:self-auto">
        ...
        <Link to="/dashboard/students" className="bg-white rounded-lg shadow p-3 sm:p-4 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="flex-1">
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{analytics?.totalReports || 0}</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-primary-100 rounded-lg flex items-center justify-center self-start sm:self-auto">
        ...
        <Link to="/dashboard/attendance" className="bg-white rounded-lg shadow p-3 sm:p-4 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="flex-1">
              <p className="text-xs font-medium text-gray-600">Attendance Rate</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{analytics?.attendanceRate || 0}%</p>
              <p className="text-[10px] text-gray-500 mt-0.5">This Month</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-orange-100 rounded-lg flex items-center justify-center self-start sm:self-auto">
        ...
        <Link to="/dashboard/students" className="bg-white rounded-lg shadow p-3 sm:p-4 hover:shadow-lg transition-shadow cursor-pointer">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div className="flex-1">
              ...
              <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{analytics?.gradeDistribution?.A || 0}</p>
              <p className="text-[10px] text-gray-500 mt-0.5">Grade A's</p>
            </div>
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-yellow-100 rounded-lg flex items-center justify-center self-start sm:self-auto">
